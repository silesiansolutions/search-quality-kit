...
Classification: Google recommendation plus local heuristics.
...
Classification: Google requirement plus local heuristics.
...
Classification: Google recommendation plus local heuristics. Structured data is not required for ordinary indexing; applicable properties and policies become requirements only for specific rich-result eligibility.
...
Classification: local heuristic; Open Graph is not a Google Search requirement.
...
Classification: Google requirement, Google recommendation, and local heuristics.
...
Classification: local heuristics; this is not a WCAG audit or ranking-factor claim.
